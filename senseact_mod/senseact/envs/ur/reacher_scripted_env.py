...
class ReacherScriptedEnv(RTRLBaseEnv, gym.core.Env):
    ...
    def __init__(self,
        ...
        super(ReacherScriptedEnv, self).__init__(communicator_setups=communicator_setups,
    ...
    def _reset_(self):
        ...
        ###################################################
        #x_target = np.array([-0.107, 0.213, 0.988])
        #self._q_target_ = np.array([-1.123, -0.421])
        ###################################################
        print('x_target: ', x_target)
        print('_q_target_: ', self._q_target_)
    ...
    def reset(self, blocking=True):
        ...
        ret = super(ReacherScriptedEnv, self).reset(blocking=blocking)
        self._episode_steps = 0
        return ret
    ...
    def terminate(self):
        ...
        super(ReacherScriptedEnv, self).close()
