...
setups = {
    'UR5_default':
              {
                  ...
                  # 'end_effector_low': np.array([-0.2, -0.05, 0.9]),
                  # 'end_effector_high': np.array([0.2, 0.05, 1.0]),
                  ...
                  # 'q_ref': np.array([ 1.58724391, -1.95, 0.6, -0.71790582, 1.63685572, 1.00910473]),
    ...
    'UR5_2D_V2':
              {
                  'host': '192.168.2.152',  # put UR5 Controller address here
                  #'pos_target_low': np.array([-0.2, -1.1, 0.0]),
                  #'pos_target_high': np.array([0.2, 1.1, 1.1]),
                  # 'pos_target_low': np.array([-0.2, -0.9, 0.4]),
                  # 'pos_target_high': np.array([0.2, 0.9, 1.0]),
                  # 'pos_target_low': np.array([-0.2, -0.3, 0.5]),
                  # 'pos_target_high': np.array([0.2, 0.4, 0.8]),
                  'pos_target_low': np.array([-0.2, -0.3, 0.5]),
                  'pos_target_high': np.array([0.2, 0.4, 1.0]),
                  'end_effector_low': np.array([-0.2, -10.0, 0.4]),
                  'end_effector_high': np.array([0.2, 0.9, 10.0]),
                  'angles_low':np.pi/180 * np.array(
                      [ 60,
                       -170,#-180
                       -150,
